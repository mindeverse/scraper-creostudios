"""Creo Studios scraper — scrape Shopify products.json, embed with local SigLIP, upsert Supabase."""
...
logger = logging.Logger("screo-studios")
...
def run() -> dict[str, Any]:
    logger.info("=== Creo Studios scraper start ===")
    ...
    for k, v in summary.items():
        logger.info("%s: %s", k, v)
    logger.info("=== Creo Studios scraper complete ===")
    return summary
